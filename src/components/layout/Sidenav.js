...
const Sidenav = ({ sortCategory, onCreate, onCreateImage, createProduct }) => {
  return (
            ...
            <div className='col'>
              <div class='btn-group dropright'>
                ...
                <div class='dropdown-menu'>
                  <button onClick={sortCategory} class='dropdown-item' value={'Indonesian Food'} >Indonesian Food</button>
                  <button onClick={sortCategory} class='dropdown-item' value={'Western'}>Western</button>
                  <button onClick={sortCategory} class='dropdown-item' value={'Chinese Food'}>Chinese Food</button>
                  <button onClick={sortCategory} class='dropdown-item' value={'Middle Eastern'}>Middle Eastern</button>
                  <button onClick={sortCategory} class='dropdown-item' value={'Beverages'}>Beverages</button>
                </div>
              </div>
                    ...
                    <div className='modal-body' align='left'>
                      <form>
                        <div className='form-group'>
                          ...
                          <input name='name' id='productId' type='text' className='form-control' onChange={onCreate} placeholder='Name Product...' />
                        </div>
                        <div className='form-group'>
                          <label className='col-form-label' style={{ color: 'black', fontFamily: 'Arial, Gadget, sans-serif', fontSize: '20px' }}>Category: </label>
                          <select className='form-control' name='category' onChange={onCreate}>
                        ...
                        <div className='form-group'>
                          ...
                          <input type='file' name='image' className='form-control' onChange={onCreateImage} />
                        </div>
                        <div className='form-group'>
                          <label className='col-form-label ' style={{ color: 'black', fontFamily: 'Arial, Gadget, sans-serif', fontSize: '20px' }}>Description </label>
                          <input name='description' type='text' className='form-control' onChange={onCreate} placeholder='Description Product...' />
                        </div>
                        <div className='form-group'>
                          <label className='col-form-label ' style={{ color: 'black', fontFamily: 'Arial, Gadget, sans-serif', fontSize: '20px' }}>Price: </label>
                          <input name='price' type='text' className='form-control' onChange={onCreate} placeholder='Price Product...' />
                        </div>
                        <div className='form-group'>
                          <label className='col-form-label ' style={{ color: 'black', fontFamily: 'Arial, Gadget, sans-serif', fontSize: '20px' }}>Quantity: </label>
                          <input name='quantity' type='text' className='form-control' onChange={onCreate} placeholder='Quantity Product...' />
                        </div>
                      </form>
                    </div>
                    <div className='modal-footer'>
                      <button type='button' className='btn btn-secondary' data-dismiss='modal'>Cancel</button>
                      <button type='submit' className='btn btn-primary' data-dismiss='modal'onClick = {createProduct}> Add Product
                      </button>
                    </div>
                  </div>
                </div>
